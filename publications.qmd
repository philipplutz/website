...
[PDF](lutz_bitschnau2025.pdf){.pub-btn} · [DOI](https://doi.org/10.1017/psrm.2025.10055){.pub-btn} · [Supplementary material](lutz_bitschnau2025_supplementary.pdf){.pub-btn} · [Replication files](https://dataverse.harvard.edu/citation?persistentId=doi:10.7910/DVN/EPX9VY){.pub-btn} · [Blog post](https://theloop.ecpr.eu/why-we-need-to-rethink-what-we-know-about-public-views-on-immigration/){.pub-btn} · [Blog post (Deutsch)](https://nccr-onthemove.ch/blog/fehlannahmen-oder-blosses-raten-einblicke-in-die-offentliche-sicht-auf-migration/){.pub-btn} · [Blog post (Français)](https://nccr-onthemove.ch/blog/croyances-erronees-ou-simples-approximations-comprendre-les-perceptions-du-public-sur-limmigration/){.pub-btn}
<details>
    <summary>Abstract</summary>
